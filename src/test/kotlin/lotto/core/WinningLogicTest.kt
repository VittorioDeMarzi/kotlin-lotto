...
class WinningLogicTest {
    ...
    fun `calculate right number of Ranks`() {
        ...
        val ticket2 = Lotto(listOf<Int>(1, 2, 3, 4, 5, 9))
        val ticket3 = Lotto(listOf<Int>(1, 2, 3, 4, 5, 8))
        val ticket4 = Lotto(listOf<Int>(1, 2, 3, 4, 8, 10))
        val ticket5 = Lotto(listOf<Int>(1, 2, 3, 8, 10, 9))
        val ticket6 = Lotto(listOf<Int>(1, 2, 10, 11, 12, 9))
